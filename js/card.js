...
const advOffer = advertisementArray;

const getAdvFragment = (array) => {
  ...
  array.forEach(function (offer) {
    ...
    advFragment.appendChild(popupElement); // добавляем содержимое в разметку
  });
  return advFragment;
};

// Вставляем объявление на сайт
popupListElement.appendChild(getAdvFragment(advOffer));
